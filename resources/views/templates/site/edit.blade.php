    ...
    <div class="page-header">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/site/list')}}">Sites</a> </li>
            ...
            <div class="card-body">
                <form id="update_form">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 col-sm-12">
                            <label class="form-label mb-0">URL: <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="url" name="url" placeholder="URL.." value="{{$site->url}}" required>
                        </div>

...
<div class="main-container container-fluid">
    ...
    <div class="page-header">
        ...
        <a role="button" class="btn btn-dealer" href="{{ url('/add/categories')}}"> <span class="fe fe-plus fs-14"></span>
            Add Categories</a>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="card-body px-3 py-2 pt-3">
            <div class="form-row align-items-center">
                <div class="col-12 col-lg-6 mb-1">
                    <label for="" class="fw-bold mb-1">Search title :</label>
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body tabs-menu-body border-0 pt-0">
                                    ...
                                    <div id="divLoader" class="text-center pt-5" style="height:300px;">
                                        <span>
                                            <i class="fe fe-spinner fa-spin"></i> Categories are being loading.. It
                                            might take few
                                            seconds.
                                        </span>
                                    </div>

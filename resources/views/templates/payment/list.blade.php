                ...
                <div class="card-header  mx-1">
                    <div class="media">
                        <div class="media-body">
                            <h6 class="mb-0 mt-1 text-muted">Payments list</h6>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body tabs-menu-body border-0 pt-0">
                                    ...
                                    <div id="divLoader" class="text-center pt-5" style="height:300px;">
                                        <span>
                                            <i class="fe fe-spinner fa-spin"></i> Payments are being loading.. It
                                            might take few
                                            seconds.
                                        </span>
                                    </div>
            ...
            if (totalPages > 0) {
                ...
                contentPagination.twbsPagination({
                    ...
                    onPageClick: function (event, page) {
                        payments((page === 1 ? page - 1 : ((page - 1) * filterLength)), filterLength);
                    }
                });
            } else {

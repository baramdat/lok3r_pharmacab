...
<div class="main-container container-fluid">
    ...
    <div class="page-header">
        ...
        <a role="button" class="btn btn-dealer" href="{{ url('/add/products')}}"> <span class="fe fe-plus fs-14"></span>
           Add Product</a>
    </div>
    <!-- PAGE-HEADER END -->
                ...
                <div class="card-header  mx-1">
                    <div class="media">
                        <div class="media-body">
                            <h6 class="mb-0 mt-1 text-muted">Product list</h6>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body tabs-menu-body border-0 pt-0">
                                    ...
                                    <div id="divLoader" class="text-center pt-5" style="height:300px;">
                                        <span>
                                            <i class="fe fe-spinner fa-spin"></i> Products are being loading.. It
                                            might take few
                                            seconds.
                                        </span>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function (e) {
        ...
        var filterItemId='{{isset($_GET['id'])?$_GET['id']:''}}';
        function setFilters() {

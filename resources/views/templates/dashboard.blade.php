                ...
                @if (!Auth::user()->hasRole('User'))
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            @if (!Auth::user()->hasRole('Site User'))
                                                <input type="hidden" id="total_product" name="total_product"
                                                    value="0">
                                                <input type="text" id="total_product_count" class="pull-right mt-1"
                                                    value="Total:         0"style="background-color: rgb(145, 188, 224); border-color:rgb(145, 188, 224); width:170px; color: white; text-align: center; border-style: none;"
                                                    readonly>
                                            @endif
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                        <div class="pull-right" style="margin-right:300px;">
                            @if (!Auth::user()->hasRole('Site User'))
                                <button type="submit" class="badge bg-success p-2 m-3">Open Locker</button>
                        ...
                        <div class="col-lg-12">
                            <form id="requested_product_form">
                                ...
                                <div class="table-responsive">
                                    ...
                                    @if (!Auth::user()->hasRole('Site User'))
                                        <input type="hidden" id="total-requested-product" name="total-requested-product"
                                            value="0">
                                        <input type="text" id="total_requested_product_count" class="pull-right"
                                            value="Total:         0"

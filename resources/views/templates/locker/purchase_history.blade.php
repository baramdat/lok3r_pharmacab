...
<div class="main-container container-fluid">
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Locker Purchase History</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">Home</a> </li>
                <li class="breadcrumb-item"><a href="{{url('/locker/details/'.$locker->id)}}">Locker #{{strtoupper($locker->number)}}</a> </li>
                <li class="breadcrumb-item active" aria-current="page">Locker Purchase History</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
                ...
                <div class="card-header  mx-1">
                    <div class="media">
                        <div class="media-body">
                            <h6 class="mb-0 mt-1 text-muted">Locker Purchase History</h6>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body tabs-menu-body border-0 pt-0">
                                    ...
                                    <div id="divLoader" class="text-center pt-5" style="height:300px;">
                                        <span>
                                            <i class="fe fe-spinner fa-spin"></i> Purchase history is being loading.. It
                                            might take few
                                            seconds.
                                        </span>
                                    </div>

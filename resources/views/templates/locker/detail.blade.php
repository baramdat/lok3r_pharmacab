            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-sm table-striped">
                        ...
                        <tr>
                            <td>Site</td>
                            <th><i class="fa fa-map-marker"></i> {{ucwords($locker->site->name)}}</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <a class="btn btn-sm btn-primary" href="{{url('/locker/purchase-history/'.$locker->id)}}">View Purchase History</a>
                            </td>
                        </tr>
                    </table>
                </div>

    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="/dashboard">
                ...
                <img src="{{asset(env('APP_LOGO'))}}" class="header-brand-img light-logo1" alt="logo2h"
                    style="height:auto !important; width:100px !important;">
            </a>
            <!-- LOGO -->
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown"
                                    class="nav-link leading-none d-flex">
                                        ...
                                        @else
                                            <img src="{{asset('/uploads/files/'.Auth::user()->photo)}}" alt="profile-user"
                                        class="avatar  profile-user brround cover-image">
                                        @endif

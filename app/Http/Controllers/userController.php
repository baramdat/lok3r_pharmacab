        ...
        try{
            ...
            if (isset($user) && sizeof($user)>0){
                ...
                foreach ($user as $usr){
                    ...
                    if(Auth::user()->id ==$usr->id || (Auth::user()->hasRole('Staff') &&$usr->hasRole('Admin'))){
                        $btun ='';
                    }else{
                        $btun = '<a class="dropdown-item btnEdit" href="/user/edit/'.$usr->id.'"><i class="fe fe-edit me-2"></i> Edit</a>
                            ...
                            <div class="product-grid6">
                                ...
                                <div class="card-body pt-2 pb-2">
                                    <div class="product-content text-center pb-0 mb-0">
                                        ...
                                        <span class="text-truncate"><i class="fa fa-map-marker"></i> '.($usr->site_id == 0 ? 'Head Office' : ucwords($usr->site->name)).'</span>
                                    </div>
                                </div>

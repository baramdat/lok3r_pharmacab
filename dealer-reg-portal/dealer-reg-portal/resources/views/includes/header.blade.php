    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src="{{asset('assets/images/brand/LOGO-FINAL.JPEG')}}" class="header-brand-img desktop-logo" alt="logo1h">
                <img src="{{asset('assets/images/brand/LOGO-FINAL.JPEG')}}" class="header-brand-img light-logo1" alt="logo2h"

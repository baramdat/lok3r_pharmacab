...
<head>
    ...
    <!-- TITLE -->
    <title>Register – Dealer Reg</title>
            ...
            <div class="">
                ...
                <div class="col col-login mx-auto mt-7">
                    <div class="text-center">
                        <img src=   "{{asset('assets/images/brand/LOGO-FINAL.JPEG')}}" class="header-brand-img m-0" alt="" style="height:59px !important; width:137px !important;">
                    </div>
                </div>
